...
- génération de documents de qualité dans différents formats (pdf, HTML, ces slides...)
- basé sur pandoc (conversion de documents)
- documents dynamiques et reproductibles
- syntaxe : variation de markdown (basé sur pandoc)
- mélange de texte et de code
- compatibilité LaTeX (figures, mise en page, etc)
...
- <https://distill.pub> : visualisation/explication, mais techniquement compliqué et pur IA, fin du journal en 2021
