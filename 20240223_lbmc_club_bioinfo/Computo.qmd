...
Environment management, Compilation, Multi-format publication (pdf, html)<br><small>[Continuous integration/Continuous deployment (CI/CD)](https://en.wikipedia.org/wiki/Continuous_integration)</small>
...
- inspired from [`Rmarkdown`](https://pkgs.rstudio.com/rmarkdown/)
...
[![](img/continuous_integration.jpg){width=700px fig-align="center"}](https://en.wikipedia.org/wiki/File:Continuous_Integration.jpg) <small>Credit: Pratik89Roy [CC-BY-SA-4.0](https://creativecommons.org/licenses/by-sa/4.0/deed.en) from [Wikimedia](https://en.wikipedia.org/wiki/File:Continuous_Integration.jpg)</small>
