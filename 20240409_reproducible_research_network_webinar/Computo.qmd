...
:::
::: {.column width="90%"}
- reproducible today, what about in the future?
- reproduce the entire computations? what about heavy computations?^[at the moment, we at least ask for a toy example to be reproduced if computations are to big but whole code should be provided] (requiring large resources)
- hardware dependent computations (e.g. GPU) and support obsolescence?
:::
::::
